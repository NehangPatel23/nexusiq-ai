...
export default async function ChatPage() {
  ...
  if (dashboard.recentProjectId) {
    redirect(`/dashboard/projects/${dashboard.recentProjectId}/chat`);
  }
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-lg text-sm text-muted-foreground">
          Chat is scoped to a project so every answer can be grounded in its data room.
        </p>
      </div>
        ...
        <Card>
          <CardContent className="space-y-4 p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Create a project and process documents before starting a cited conversation.
            </p>
            <Button asChild>
              ...
              <Card className="transition-colors hover:border-primary/30">
                <CardContent className="flex flex-wrap items-center justify-between gap-4 p-5">
                  ...
                  <Button asChild variant="secondary">
                    <Link href={`/dashboard/projects/${project.id}/chat`}>Open chat</Link>
                  </Button>
                </CardContent>
              </Card>
            </li>
