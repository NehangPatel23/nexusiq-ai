...
const TYPE_VARIANTS: Record<ProjectType, string> = {
  MA: "border-violet-500/30 bg-violet-500/10 text-violet-300",
  VENDOR_DD: "border-blue-500/30 bg-blue-500/10 text-blue-300",
  AUDIT: "border-amber-500/30 bg-amber-500/10 text-amber-300",
  INVESTMENT: "border-emerald-500/30 bg-emerald-500/10 text-emerald-300",
